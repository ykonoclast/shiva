...
${OBJECTDIR}/src/processutils.o: src/processutils.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -include debug.h `pkg-config --cflags libbsd` -std=c11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/processutils.o src/processutils.c

${OBJECTDIR}/src/shiva.o: src/shiva.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -include debug.h `pkg-config --cflags libbsd` -std=c11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/shiva.o src/shiva.c

${OBJECTDIR}/src/uprollutils.o: src/uprollutils.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -include debug.h `pkg-config --cflags libbsd` -std=c11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/uprollutils.o src/uprollutils.c
